...
class SimData1 implements Runnable {
    ...
    public void rndvals() {
		...
		else  
		{
		 ...
		 Pstate[i]=pump[i]; Vstate[i]=valve[i];
        }
...
//if level >HH pump is off
        ...
        for (int i = 0; i < 5; i++) {
                        ...
                        //if manual overwrite is NOT set then set values 
                         if(pumpOR[i] || valveOR[i]) {GUI.lmanual.setText("Manual On"+ Integer.toString(i));}
    ...
    public void setLinkToPanel(bPanel mPanel, JPanel aPanel, JPanel bPanel, JPanel cPanel, JPanel dPanel, JPanel ePanel) {
    ...
    public void paint(Graphics g) {
        ...
        g.fillRect(displayPanel.getX() + SimData1.inset + SimData1.left, SimData1.top, SimData1.width - 2 * SimData1.inset, SimData1.height - SimData1.inset);

        g.setColor(fillColor);
        g.fillRect(displayPanel.getX() + SimData1.inset + SimData1.left, top + height - inset - Level[0], SimData1.width - 2 * SimData1.inset, Level[0]);
        ...
        g.fill3DRect(displayPanel.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 160, 15, 8, true);
        if (!hi[0]) {
            g.setColor(Color.CYAN);
        } else {
            g.setColor(Color.RED);
        ...
        g.fill3DRect(displayPanel.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 120, 15, 8, true);
        ...
        g.fill3DRect(displayPanel.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 80, 15, 8, true);
        ...
        g.fill3DRect(displayPanel.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 40, 15, 8, true);
        ...
        g.setColor(Color.BLACK);
        g.fillRect(displayPanel1.getX() + SimData1.inset + SimData1.left, SimData1.top, SimData1.width - 2 * SimData1.inset, SimData1.height - SimData1.inset);

        g.setColor(fillColor);
        g.fillRect(displayPanel1.getX() + SimData1.inset + SimData1.left, top + height - inset - Level[1], SimData1.width - 2 * SimData1.inset, Level[1]);
        ...
        g.fill3DRect(displayPanel1.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 160, 15, 8, true);
        ...
        g.fill3DRect(displayPanel1.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 120, 15, 8, true);
        ...
        g.fill3DRect(displayPanel1.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 80, 15, 8, true);
        ...
        g.fill3DRect(displayPanel1.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 40, 15, 8, true);
        ...
        g.setColor(Color.BLACK);
        g.fillRect(displayPanel2.getX() + SimData1.inset + SimData1.left, SimData1.top, SimData1.width - 2 * SimData1.inset, SimData1.height - SimData1.inset);

        g.setColor(fillColor);
        g.fillRect(displayPanel2.getX() + SimData1.inset + SimData1.left, top + height - inset - Level[2], SimData1.width - 2 * SimData1.inset, Level[2]);
        ...
        g.fill3DRect(displayPanel2.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 160, 15, 8, true);
        ...
        g.fill3DRect(displayPanel2.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 120, 15, 8, true);
        ...
        g.fill3DRect(displayPanel2.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 80, 15, 8, true);
        ...
        g.fill3DRect(displayPanel2.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 40, 15, 8, true);


        g.setColor(SimData1.tankColor);
        g.fillRoundRect(displayPanel3.getX() + SimData1.left, SimData1.top, SimData1.width, SimData1.height, 20, 20);
        g.setColor(Color.BLACK);
        g.fillRect(displayPanel3.getX() + SimData1.inset + SimData1.left, SimData1.top, SimData1.width - 2 * SimData1.inset, SimData1.height - SimData1.inset);

        g.setColor(fillColor);
        g.fillRect(displayPanel3.getX() + SimData1.inset + SimData1.left, top + height - inset - Level[3], SimData1.width - 2 * SimData1.inset, Level[3]);
        ...
        g.fill3DRect(displayPanel3.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 160, 15, 8, true);
        if (!hi[3]) {
            g.setColor(Color.CYAN);
        } else {
            g.setColor(Color.RED);
        }
        g.fill3DRect(displayPanel3.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 120, 15, 8, true);
        if (!lo[3]) {
            g.setColor(Color.CYAN);
        } else {
            g.setColor(Color.RED);
        }
        g.fill3DRect(displayPanel3.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 80, 15, 8, true);
        if (!ll[3]) {
            g.setColor(Color.CYAN);
        } else {
            g.setColor(Color.RED);
        }
        g.fill3DRect(displayPanel3.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 40, 15, 8, true);
        ...
        g.setColor(Color.BLACK);
        g.fillRect(displayPanel4.getX() + SimData1.inset + SimData1.left, SimData1.top, SimData1.width - 2 * SimData1.inset, SimData1.height - SimData1.inset);
        g.setColor(fillColor);
        g.fillRect(displayPanel4.getX() + SimData1.inset + SimData1.left, top + height - inset - Level[4], SimData1.width - 2 * SimData1.inset, Level[4]);
        ...
        g.fill3DRect(displayPanel4.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 160, 15, 8, true);
        ...
        g.fill3DRect(displayPanel4.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 120, 15, 8, true);
        if (!lo[4]) {
            g.setColor(Color.CYAN);
        } else {
            g.setColor(Color.RED);
        }
        g.fill3DRect(displayPanel4.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 80, 15, 8, true);
        ...
        g.fill3DRect(displayPanel4.getX() + SimData1.left - 3, SimData1.top + (SimData1.height - SimData1.inset) - 40, 15, 8, true);
	 ...
	 String[] tokens = line.split(delims);
            ...
            for (int i = 0; i < tokens.length; i++)
            {
               ...
               if (Integer.parseInt(tokens[i])==0 )
               {
                   ...
                   if(i!=5)
                   {
                   GUI.sbalarm[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("smallred.png")));
                   }

                   else 

                   {
		      GUI.alarmImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("red_light.png")));
                   }
                try {
                Thread.sleep(3000);
            } catch (InterruptedException ie) {
               ...
               else  
               {
              	   if(i!=5)
              	   {
                    GUI.sbalarm[i].setIcon(new javax.swing.ImageIcon(getClass().getResource("smallgreen.png")));
                   }

                   else 
                   	{
		    GUI.alarmImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("green_light.png")));
